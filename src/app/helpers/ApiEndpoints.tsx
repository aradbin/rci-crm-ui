...
const ACCOUNT_CONNECT_URL = `${BASE_URL}/account`

export { BASE_URL, BASE_URL_COMMUNICATION, AUTH_URL, USERS_URL, CUSTOMERS_URL, CUSTOMER_SETTINGS_URL, CONTACTS_URL, CUSTOMER_CONTACTS_URL, TASKS_URL, EMAIL_URL, WHATSAPP_URL, PHONE_URL, VOIP_URL, MESSAGES_URL, SETTINGS_URL, ACCOUNT_CONNECT_URL }
